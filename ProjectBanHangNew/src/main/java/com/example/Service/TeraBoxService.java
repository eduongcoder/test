...
public class TeraBoxService {
    ...
    public void loginAndUploadFile(String username, String password, String filePath) {
        try {
            ...
            // Đăng nhập
            WebElement loginButton = driver.findElement(By.className("login_button_id")); // Sửa lại với ID đúng của nút login
            loginButton.click();

            WebElement usernameField = driver.findElement(By.id("email-input")); // Sửa lại với ID đúng của trường username
            usernameField.sendKeys(username);

            WebElement passwordField = driver.findElement(By.id("pwd-input")); // Sửa lại với ID đúng của trường password
            passwordField.sendKeys(password);

            WebElement submitButton = driver.findElement(By.className("login-submit-btn btn-abled")); // Sửa lại với ID đúng của nút submit
            submitButton.click();
